...
window.addEventListener('DOMContentLoaded', () => {
  ...
  var dialogLoginBtnElement = document.querySelector('.app__dialog-login');
  ...
  dialogLoginBtnElement.addEventListener('click', loginSubmitted, false);
  ...
  //Login Submitted Method
  function loginSubmitted() {
    dialogLoginBtnElement.style.display = 'block';
  ...
  function scan(forSelectedPhotos = false) {
    ...
    QRReader.scan(result => {
      ...
      scanningEle.style.display = 'none';
      videoElement.style.display = 'block';
      dialogLoginBtnElement.style.display = 'none';
      
      if (isURL(result)) {
        dialogOpenBtnElement.style.display = 'block';
      }
